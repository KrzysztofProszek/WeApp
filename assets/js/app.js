...
let apiUrl = 'https://api.weatherapi.com/v1/current.json?key=b8927f68deee4055947165516231506&aqi=no&q='
...
weatherForm.addEventListener('submit', (event) => {
    ...
    .then((dataFromApi) => {
        ...
        let view = ``
        // view += `In ${dataFromApi.location.name} temperature is: ${dataFromApi.current.temp_c} &deg;C`
...
let showError = () => {
apiDataContainer.innerHTML = `<div class='weather__error'>City not found or API is down</div>`
}